...
public class BankStatement {
    ...
    private static final String FILE ="D:\\BackEnd\\project\\myStatement.pdf";
    ...
    public List<Transaction> generateStatement (String accountNumber, String startDate, String endDate) throws DocumentException, FileNotFoundException {
        ...
        List<Transaction> transactionList = transactionRepo.findAll().stream().filter(transaction ->
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Jave Banking System:)"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("72, address, right"));
